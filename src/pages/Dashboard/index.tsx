...
export function Dashboard() {
  ...
  const handleUpdateFood = async (food: FoodInterface): Promise<void> => {
    try {
  ...
  const handleEditFood = (food: FoodInterface): void => {
    setEditingFood(food);
  ...
  return (
    <>
      ...
      <ModalAddFood isOpen={modelOpen} setIsOpen={toggleModal}
